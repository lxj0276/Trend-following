function[tableD,tableK]=RBreaker_update6(data,paras,transactioncost,breakpara,tol)
% may hold overnight, break based on previous K's change size : dif=high-low 
[nrow ncol]=size(data);
tick=0.2;
endtime=151500;
...
for minuteK=days(2):nrow
    ...
    elseif currenthold==1 %long position, hold the position till a break or endtime
        breakprc=tickround(maxbuy-breakpara*diff,tick);        
        ...
        breakprc=tickround(minsell+breakpara*diff,tick);
